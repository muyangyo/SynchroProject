...
public class AdminOperationAspect {
    ...
    @Around("@annotation(com.muyangyo.fileclouddisk.common.aspect.annotations.AdminRequired) || @within(com.muyangyo.fileclouddisk.common.aspect.annotations.AdminRequired)")
