...
public class FileSyncManager {
    ...
    public FileSyncManager(String serverIp, int serverPort, List<SyncInfo> syncs, ExecutorService settingThreadPool, SyncInfoMapper syncInfoMapper, SyncLogService syncLogService) {
                ...
                settingThreadPool.submit(() -> {
                    ...
                    try {
                        ...
                        FileSyncOneShotProcessor fileSyncOneShotProcessor = new FileSyncOneShotProcessor(sync.getLocalAddress(),
                                sync.isFirst(), serverIp, serverPort, sync.getUsername(), sync.getPassword(), syncInfoMapper, syncLogService);
