...
public class UserOperationLimitAspect {
    ...
    @Around("@annotation(com.muyangyo.filesyncclouddisk.common.aspect.annotations.UserOperationLimit) || @within(com.muyangyo.filesyncclouddisk.common.aspect.annotations.UserOperationLimit)")
