...
public class LocalOperationAspect {
    ...
    @Around("@annotation(com.muyangyo.filesyncclouddisk.common.aspect.annotations.LocalOperation) || @within(com.muyangyo.filesyncclouddisk.common.aspect.annotations.LocalOperation)")
