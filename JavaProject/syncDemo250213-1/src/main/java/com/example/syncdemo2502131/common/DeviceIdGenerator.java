package com.example.syncdemo2502131.common;
...
public class DeviceIdGenerator {
    ...
    private static String generateDeviceId() {
        ...
        throw new RuntimeException("Failed to generate device ID");
    }
    ...
    public static String getOriginalDeviceId(String confuseDeviceId) {
        ...
        if (parts.length != 4) {
            throw new IllegalArgumentException("Invalid device ID: " + confuseDeviceId);
        }
