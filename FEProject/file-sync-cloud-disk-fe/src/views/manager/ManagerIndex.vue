<template>
  ...
  <el-row :gutter="20" class="main-row">
    ...
    <!-- 侧边栏菜单 -->
    <el-menu default-active="2-1" class="el-menu-vertical-demo" :collapse="showMenu" @open="handleOpen"
      ...
      <el-sub-menu index="1">
        ...
        <!-- 二级菜单 -->
        <el-menu-item index="1-1" @click="navigateTo('/manager/sync_manager/sync_setting_manager')">
          <template #default>
            <el-icon>
              <Setting/>
            </el-icon>
        ...
        <el-menu-item index="1-2" @click="navigateTo('/manager/sync_manager/sync_log_manager')">
          <template #default>
            <el-icon>
              <List/>
            </el-icon>
      ...
      <el-sub-menu index="2">
        ...
        <!-- 二级菜单 -->
        <el-menu-item index="2-1" @click="navigateTo('/manager/cloud_manager/cloud_setting_manager')">
          <template #default>
            <el-icon>
              <Setting/>
            </el-icon>
        ...
        <el-menu-item index="2-2" @click="navigateTo('/manager/cloud_manager/cloud_log_manager')">
          <template #default>
            <el-icon>
              <List/>
            </el-icon>
